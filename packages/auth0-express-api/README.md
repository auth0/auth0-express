...
| [Handle a failed exchange](./EXAMPLES.md#handling-a-failed-connection-exchange) | Tell a misconfiguration from a tenant refusal with `isConnectionExchangeError` |
